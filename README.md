...
- [Télécharger le zip du projet à cette adresse](https://github.com/Dreeckan/js-rattrapage/archive/refs/heads/main.zip) et me transmettre un Zip à la fin de l'examen
...
- Écrire les méthodes suivantes dans `Book`:
